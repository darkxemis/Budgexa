...
namespace Budgexa.Infrastructure.Migrations
{
    ...
    [Migration("20260729143544_AddUnitMeasureToBudgetLineInvoiceLine")]
    partial class AddUnitMeasureToBudgetLineInvoiceLine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Budgexa.Domain.Entities.PublicBudget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("PublicBudgets", (string)null);
                });

            modelBuilder.Entity("Budgexa.Domain.Entities.PublicBudgetLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PublicBudgetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PublicBudgetId");

                    b.ToTable("PublicBudgetLines", (string)null);
                });
            ...
            modelBuilder.Entity("Budgexa.Domain.Entities.PublicBudgetLine", b =>
                {
                    ...
                    b.HasOne("Budgexa.Domain.Entities.PublicBudget", "PublicBudget")
                        .WithMany("Lines")
                        .HasForeignKey("PublicBudgetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Item");

                    b.Navigation("PublicBudget");
                });
