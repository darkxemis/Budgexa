namespace Budgexa.Application.Customers.Validators;

using Budgexa.Application.Common.DTOs;
using Budgexa.Application.Common.Validators;
using FluentValidation;

public sealed class CustomerGridRequestDtoValidator : AbstractValidator<GridRequestDto>
{
    ...
    public CustomerGridRequestDtoValidator()
    {
