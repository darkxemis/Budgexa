namespace Budgexa.Application.Invoices.Validators;

using Budgexa.Application.Common.DTOs;
using Budgexa.Application.Common.Validators;
using FluentValidation;

public sealed class InvoiceGridRequestDtoValidator : AbstractValidator<GridRequestDto>
{
    ...
    public InvoiceGridRequestDtoValidator()
    {
